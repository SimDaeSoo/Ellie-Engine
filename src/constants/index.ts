...
const BLOCK_PROPERTIES: EnumDictionary<BLOCK_TYPES, [number, number]> = {
  [BLOCK_TYPES.IRON]: [120, 1],
  [BLOCK_TYPES.OBSIDIAN]: [120, 1],
  [BLOCK_TYPES.STONE]: [100, 1],
  [BLOCK_TYPES.PEBBLE]: [100, 1],
  [BLOCK_TYPES.DIRT]: [80, 1],
  [BLOCK_TYPES.SAND]: [60, 1],
  [BLOCK_TYPES.WATER]: [100, 10],
  [BLOCK_TYPES.LAVA]: [60, 10],
  [BLOCK_TYPES.ACID]: [60, 10],
  [BLOCK_TYPES.EMPTY]: [0, 0],
};

const BLOCKS: EnumDictionary<BLOCK_TYPES, [number, number, number]> = {
  [BLOCK_TYPES.IRON]: [190, 190, 180],
  [BLOCK_TYPES.OBSIDIAN]: [20, 20, 40],
...
const BLOCK_TYPE_VALUES: EnumDictionary<BLOCK_TYPES, number> = {
  ...
  [BLOCK_TYPES.OBSIDIAN]: 0b00000000001010000001010000010100,
